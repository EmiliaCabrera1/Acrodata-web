...
const JuegoPortada = () => {
  return (
    <div className="flex relative mx-auto items-center h-[70vh] w-[85vw] rounded-2xl gap-3 border-verde-intermedio border-1 px-4 py-12 my-5 justify-around overflow-visible">
