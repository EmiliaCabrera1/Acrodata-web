...
const JuegoPortada = () => {
  return (
    <div className="h-full flex items-center justify-center">
      <div className="flex relative mx-auto items-center h-[70vh] w-[85vw] rounded-2xl gap-3 border-verde-intermedio border-1 px-4 py-12 justify-around overflow-visible">
